...
import json
import os
from Project.decorators import admin_only
from .decorators import allowed_users, unauthenticated_user
from django.shortcuts import render, redirect
from django.utils.regex_helper import Group
from .models import DeliveryAddress, Employee, Item, Category, Order, OrderItem, Product, Supplier
from .models import Customorder
from .forms import ItemCreate, CreateUserForm, CustomorderForm, addEmployeeform
from django.http import HttpResponse, JsonResponse
from .filters import CustomorderFilter, ProductFilter, employeeFilter
...
def export_to_csv(request):
    ...
    orderitemfields = orderitems.values_list(
